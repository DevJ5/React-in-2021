...
import CartContext, { CartItemInterface } from './cart-context';
...
const CartProvider = (props: { children: ReactNode }): JSX.Element => {
  const [cartState, dispatchCartAction] = useReducer(
    cartReducer,
    defaultCartState
  );

  const addItemToCartHandler = (item: CartItemInterface) => {
    dispatchCartAction({ type: ActionType.ADD, item: item });
  };

  const removeItemFromCartHandler = (id: CartItemInterface['id']) => {
